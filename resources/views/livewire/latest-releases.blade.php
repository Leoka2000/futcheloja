                ...
                <div
                    ...
                    <div class="w-full h-auto rounded-md relative">
                        <img src="{{ asset('storage/' . ($firstImage ?? 'default.jpg')) }}" alt="{{ $product->name }}"
                            class="h-72 w-full rounded-md transition-opacity duration-300" loading="lazy"
                        ...
                        <!-- Placeholder -->
                        <div class="absolute top-0 left-0 w-full h-full flex justify-center items-center rounded-t-md bg-white dark:bg-gray-800 transition-opacity duration-300"
                    ...
                    <div class="flex flex-col flex-grow p-5">
                        ...
                        <a>
                            <h5
                                class="mb-2 xl:text-base text-sm font-bold tracking-tight text-gray-900 dark:text-white truncate">
