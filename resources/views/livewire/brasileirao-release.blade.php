<section class="py-20 relative isolate overflow-x-hidden overflow-y-hidden bg-white dark:bg-inherit md:px-0">
    <h3
        ...
        <span
            class="inline-flex items-center mx-1 justify-center rounded-md bg-green-50 dark:bg-green-200 px-3 py-2 text-xs font-medium text-green-700 ring-1 ring-green-600/20 dark:ring-green-500 ring-inset">
    ...
    <div class="px-4 mx-auto sm:px-12 xl:px-5">
        <swiper-container pagination="true" navigation="true" loop="true" slides-per-view="1" space-between="20"
            ...
            <swiper-slide class="mb-10">
                <!-- Card Container -->
                <div
                    class="xl:h-full h-auto flex flex-col  rounded-lg  dark:bg-gray-800 bg-gray-50 text-sm relative shadow-md">
                    <span
                        class="inline-flex items-start gap-1 top-2 z-10 left-2 absolute rounded-md bg-yellow-100 px-2 py-1 text-xs font-medium text-yellow-700 ring-1 ring-yellow-400 dark:ring-yellow-600 ring-inset"><svg
                    ...
                    <div class="w-full h-auto rounded-md relative">
                        <img data-src="{{ asset('storage/' . ($firstImage ?? 'default.jpg')) }}"
                            alt="{{ $product->name }}"
                            class="h-72 w-full rounded-md transition-opacity duration-300 lazy-image" loading="lazy" />
                        <span
                        ...
                        <div
                            ...
                            <span class="loader">
                                <div role="status"
                                    class="flex items-center flex-col h-56 w-56 sm:h-72 md:w-56 sm:w-72 justify-center bg-gray-300 rounded-lg sm:rounded-t-lg animate-pulse dark:bg-gray-700">
                    ...
                    <div class="flex flex-col flex-grow p-5">
                        ...
                        <a href="#">
                            <h5
                                class="mb-2 xl:text-base text-sm font-bold tracking-tight text-gray-900 dark:text-white">
                        ...
                        <div class="mb-1 gap-1">
                            <p class="text-sm font-semibold dark:text-green-600 text-green-500">R$ {{$product->price}}
                                <span class="text-xs mt-1 dark:text-gray-600 text-gray-400"><del>R$ 159.99</del></span>
                            </p>
                        </div>
                        ...
                        <div class="flex items-center text-sm mb-2 gap-1">
                            <p class="text-sm">Ou <strong>12x</strong> de <span
                                    class="dark:text-green-600 text-green-500 text-sm font-semibold">R$ 15,24</span></p>
                        </div>
