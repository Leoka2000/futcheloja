    ...
    <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
            ...
            <div class="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
                <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
                    ...
                    <div class="space-y-6">
                        ...
                        <div
                            class="rounded-lg border items-center flex flex-col gap-1 border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                            <x-mary-icon name="o-x-mark"
                                class="w-12 h-12 bg-gray-200 text-gray-400 dark:bg-gray-700 darktext-gray-500 p-2 rounded-full" />
                        ...
                        @endphp
                        <div
                            class="rounded-lg border border-gray-200 relative bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                            <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                <a href="#" class="shrink-0 md:order-1">
                                    <img class="h-24 w-24" src="{{ Storage::url($firstImage) }}"
          ...
          ">
                                                <span x-show="!loading">
                                                    <x-mary-button icon="o-minus"
                                                        class="btn-circle text-red-500 dark:red-400 btn-sm" />
                                                </span>
                                                <span x-show="loading">
                                                    <x-mary-button
                                                        class="btn-circle relative text-green-500  dark:green-400 btn-sm">
                                        ...
                                        <x-mary-input style="width:50px!important;" readonly type="text"
                                            ...
                                            class=" btn-sm shrink-0 border-0 bg-transparent mx-2 text-center text-sm font-medium text-gray-900 focus:outline-none focus:ring-0  dark:text-white"
          ...
          ">
                                                <span x-show="!loading">
                                                    <x-mary-button icon="o-plus"
                                                        class="btn-circle text-green-500 dark:green-400 btn-sm" />
                                                </span>
                                                <span x-show="loading">
                                                    <x-mary-button
                                                        class="btn-circle relative text-green-500 dark:green-400 btn-sm">
      ...
      "> <span x-show="!loading">
                                                <x-mary-button type="submit" icon="o-trash"
                                                    class="btn-sm btn-circle  text-red-500 dark:red-400 inline-flex  ">
                                                </x-mary-button>
                                            </span>
                                            <span x-show="loading">
                                                <x-mary-button type="submit"
                                                    class="btn-sm btn-circle relative text-red-500 dark:text-red-400 inline-flex ">
                                                    <x-mary-loading class="dark:text-gray-500 text-gray-400" />
                                                </x-mary-button>
                                            </span>
                                        </a>
                                ...
                                <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        <form x-data="{ loading: false }"
                                            ...
                                            <ul
                                                class="items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 mb-10 rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                                <li
                                                    ...
                                                    <div class="flex items-center ps-3">
                                                        ...
                                                        <label for="size-p-{{ $item->id }}"
                                                            class="w-full py-3 ms-2 text-sm mr-2 font-medium text-gray-900 dark:text-gray-300">P</label>
                                                    </div>
                                                </li>
                                                ...
                                                <li
                                                    ...
                                                    <div class="flex items-center ps-3">
                                                        ...
                                                        <label for="size-m-{{ $item->id }}"
                                                            class="w-full py-3 ms-2 text-sm mr-2 font-medium text-gray-900 dark:text-gray-300">M</label>
                                                    </div>
                                                </li>
                                                ...
                                                <li
                                                    ...
                                                    <div class="flex items-center ps-3">
                                                        ...
                                                        <label for="size-g-{{ $item->id }}"
                                                            class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">G</label>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="w-full dark:border-gray-600">
                                                    <div class="flex items-center ps-3">
                                                        ...
                                                        <label for="size-gg-{{ $item->id }}"
                                                            class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">GG</label>
                                                    </div>
                                                </li>
                                                <li class="w-28 h- border-b  sm:border-b-0">
                                                    <div>
                                                        <x-mary-button type="submit"
                                                            class="btn-md border-none  relative w-5 ml-2 text-sm"
                                                            ...
                                                            <span class="w-full" x-show="loading">
                                                                <x-mary-loading
                    ...
                    <h2 class="text-xl font-semibold mt-6 mb-6 text-gray-900 dark:text-white sm:text-2xl">Informações de
                        entrega</h2>
                    ...
                    <div
                            ...
                            <div class="space-y-2">
                                ...
                                <dl class="flex items-center justify-between gap-4">
                                    ...
                                    <dd class="text-base font-medium text-green-600"> <span
                                            class="inline-flex items-center rounded-md bg-green-50 dark:bg-green-200 px-3 py-1 text-xs font-medium text-green-700 ring-1 ring-green-600/20 dark:ring-green-500 ring-inset">
                                            Grátis</span></dd>
                                </dl>
                            </div>
                        ...
                        <div class="flex-inline  items-center flex space-x-1 xl:gap-2 gap-3 my-1">
                            <img src="{{asset('mastercard.svg')}}" alt="MasterCard"
                                class="h-5 border border-gray-200 dark:border-gray-600 shadow-sm rounded-md p-1 px-2">
                        ...
                        <div class="flex items-center justify-center gap-2">
                            ...
                            <a title=""
                                ...
                                <img src="{{asset('pix.png')}}" alt="Pix"
                                    class="h-7 border border-gray-200 dark:border-gray-600  shadow-sm rounded-md -p-36">
                            </a>
                            @else
                            ...
                            <div x-data="{ modalOpen: false }" @keydown.escape.window="modalOpen = false"
                                ...
                                <x-mary-button @click="modalOpen=true" class="btn w-full">
                                    <img src="{{ asset('pix.png') }}" alt="Pix" class="h-12 shadow-sm rounded-md p-1">
                                    Pagar com Pix
                                </x-mary-button>
                                @else
                                    ...
                                    <div x-show="modalOpen"
                                        ...
                                        <div x-show="modalOpen" x-trap.inert.noscroll="modalOpen"
                                            ...
                                            <div class="flex items-center justify-between pb-3">
                                                <h3 class="text-lg text-gray-800 dark:text-gray-200 font-semibold">Valor
                                                    a ser pago: R$ {{number_format($totalPrice, 2) }} </h3>
                                                <button @click="modalOpen=false"
                                                    class="absolute top-0 right-0 flex items-center justify-center w-8 h-8 mt-5 mr-5 text-gray-600 dark:text-gray-400 rounded-full hover:text-gray-800 dark:hover:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
