<section class="relative overflow-x-hidden  isolate py-20 bg-white dark:bg-inherit">
    ...
    <span class="absolute top-0 right-0 flex flex-col items-end mt-0 -mr-16 opacity-60">
        <span
            class="container hidden w-screen h-32 max-w-xs mt-20 transform rounded-full rounded-r-none md:block md:max-w-xs lg:max-w-lg 2xl:max-w-3xl bg-yellow-100 dark:bg-yellow-400"></span>
    </span>
    ...
    <div class="relative px-16 mx-auto max-w-7xl">
        ...
        <h2
            class="relative max-w-lg mt-5 mb-10 text-4xl font-semibold leading-tight text-gray-900 dark:text-gray-100 lg:text-5xl">
