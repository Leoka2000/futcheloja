    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" onsubmit="setLoadingState()">
            ...
            <div class="mt-4">
                ...
                <x-input id="password_confirmation" class="block w-full mt-1 text-gray-600 dark:text-gray-300"
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ms-2">
                            ...
                            'terms_of_service' => '<a target="_blank" href="'.route('terms.show').'"
                                class="text-sm text-gray-600 underline rounded-md dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">'.__('Termos
                                de Serviço').'</a>',
                            'privacy_policy' => '<a target="_blank" href="'.route('policy.show').'"
                                class="text-sm text-gray-600 underline rounded-md dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">'.__('Política
                                de Privacidade').'</a>',
                            ]) !!}
                        </div>
                    </div>
